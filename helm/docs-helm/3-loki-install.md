NAME: loki
LAST DEPLOYED: Sat Jan 24 15:41:10 2026
NAMESPACE: lgtm
STATUS: deployed
REVISION: 1
NOTES:
...
Tip:
  ...
  Watch the deployment status using the command: kubectl get pods -w --namespace lgtm
...
You can test to send data from outside the cluster by port-forwarding the gateway to your local machine:
  ...
  kubectl port-forward --namespace lgtm svc/loki-gateway 3100:80 &
